...
def game(screen, clock):
    ...
    FPS = 60
    # images
    background = pygame.image.load(path + 'třída.png')
    background = pygame.transform.scale(background, (1280, 720))
    staple = pygame.image.load(path + 'staple.png')
    staple = pygame.transform.scale(staple, (60, 60))
    compasses = pygame.image.load(path +'compasses.png')
    ...
    table_skin_closed = pygame.image.load(path +'tableclosed.png')
    table_skin_closed = pygame.transform.scale(table_skin_closed, (160, 80))
    table_skin_open = pygame.image.load(path + 'table.png')
